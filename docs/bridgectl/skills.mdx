...
diagnose an integration, or prepare a sanitized bug report.
...
| Workflow | Result |
| :--- | :--- |
| API onboarding | Register an ERP endpoint, test connectivity, generate a tool manifest, validate it, apply it, and verify MCP discovery |
