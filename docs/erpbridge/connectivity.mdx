---
sidebar_position: 4
title: Connectivity & Transport Guide
...
HTTP requests and stdio use their session or process fallback.

## 5. Connector Resilience

Every outbound call to an upstream ERP goes through a resilient client with three layers of defense. This keeps legacy ERP systems stable even when AI agents send a heavy or bursty workload.
