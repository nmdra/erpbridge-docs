...
For the full list of server environment variables, see the [Environment Variables Reference](./environment-variables.mdx).
...
3. **Generate a new tool:**
   ```bash title="Generate a tool from OpenAPI"
