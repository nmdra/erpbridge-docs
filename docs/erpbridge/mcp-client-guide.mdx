...
description: Build MCP clients that connect to ERPBridge over Streamable HTTP or stdio with examples in Python and TypeScript.
...
| `-32601` | Method not found | The tool name does not exist. Use `tools/list` to find it. |
