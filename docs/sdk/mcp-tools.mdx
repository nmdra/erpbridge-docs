...
- `listTools` may include standard tool annotations and namespaced `_meta`
  guidance such as `whenToUse`, examples, and allowed roles. Custom `_meta`
  keys are client-dependent and may not be forwarded into the model context.
